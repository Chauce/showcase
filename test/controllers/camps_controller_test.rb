...
class CampsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create camp" do
    assert_difference('Camp.count') do
      post camps_url, params: { camp: { latLong: @camp.latLong, latitude: @camp.latitude, longitude: @camp.longitude, name: @camp.name, weatheroverview: @camp.weatheroverview } }
    end
  ...
  test "should update camp" do
    patch camp_url(@camp), params: { camp: { latLong: @camp.latLong, latitude: @camp.latitude, longitude: @camp.longitude, name: @camp.name, weatheroverview: @camp.weatheroverview } }
