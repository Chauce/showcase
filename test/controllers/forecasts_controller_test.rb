...
class ForecastsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create forecast" do
    assert_difference('Forecast.count') do
      post forecasts_url, params: { forecast: { lat: @forecast.lat, long: @forecast.long, precip: @forecast.precip, snow: @forecast.snow, temp: @forecast.temp, timestamp_utc: @forecast.timestamp_utc } }
    end
  ...
  test "should update forecast" do
    patch forecast_url(@forecast), params: { forecast: { lat: @forecast.lat, long: @forecast.long, precip: @forecast.precip, snow: @forecast.snow, temp: @forecast.temp, timestamp_utc: @forecast.timestamp_utc } }
